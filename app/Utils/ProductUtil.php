...
class ProductUtil extends Util
{
     ...
     * @return bool
     */
    public function createSingleProductVariation($product, $sku, $purchase_price, $dpp_inc_tax, $profit_percent,$discount,  $selling_price, $selling_price_inc_tax, $combo_variations = [])
    {
